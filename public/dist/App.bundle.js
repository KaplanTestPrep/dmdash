...
(0, _jquery2.default)(document).ready(function () {
  ...
  (0, _jquery2.default)("#refIdtoId").submit(function (e) {
    return handleRefIdtoId(e);
  });
});
...
function handleRefIdtoId(e) {
  ...
  videos.forEach(function (video) {
    _jquery2.default.ajax({
      ...
      (0, _jquery2.default)("ul#success").append("<li>" + video + ": " + res + "</li>");
    }).fail(function (err) {
      completed++;
      fail++;
      ...
      (0, _jquery2.default)(".progress-bar").css("width", completed / total * 100 + "%");
      (0, _jquery2.default)("#percentage").text("Progress: " + Math.round(completed / total * 100) + "%");
      (0, _jquery2.default)("ul#fail").append("<li>" + video + " - Error: " + err.responseText + "</li>");
    });
  });
}
...
function handleRemoveTextTrack(e) {
  ...
  var videosArr = (0, _jquery2.default)("#vidoesToUpdate").val().trim().split(/[\s,]+/);
...
(0, _jquery2.default)(document).ready(function () {
  ...
  var projectList = (0, _jquery2.default)("#hapyakProjects").DataTable({
    ...
    columns: [{ data: "id" }, { data: "title" }, { data: "video_id" }, { data: "video_source_id" }, { data: "track_id" }, { data: "tags" }],
    columnDefs: [
    // {
    //   targets: [0],
    //   visible: false,
    //   searchable: true
    // },
    { width: 60, targets: [0] }, { width: 300, targets: [1] }, { width: 60, targets: [2] }, { width: 400, targets: [3] }, { width: 60, targets: [4] }],
    autoWidth: true,
    pageLength: 25
  });
  ...
  var projectDetailsList = (0, _jquery2.default)("#hapyakProjectDetails").DataTable({
    ...
    columns: [{ data: "id" }, { data: "start" }, { data: "end" }, { data: "type" }, { data: "class" }],
    // columnDefs: [
    //   {
    //     targets: [0],
    //     visible: true,
